...
#include "C:\Users\MarthaAlicia\Desktop\Microcontroladores\libraries\uart\UART.h"
...
{
    OC3RS = promedio_ADC*.7;//Transformamos resultado del ADC a PWM con 2949/4096=.72
    _T3IF = 0;
}
...
int main(void) {
    ...
    while(1)
    {
        sprintf(buf,"ADC=%d,",promedio_ADC);
