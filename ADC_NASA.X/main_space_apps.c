...
//                if(PORTD != val_ant)
//                    WriteUART2('b');
//                sprintf(buf,"%d\n",lectura_ADC(ECG1_pin));
//                WriteStringUART2(buf);
//                break;
//            case 4:
//                if(PORTD != val_ant)
//                    WriteUART2('c');
//                sprintf(buf,"%d\n",lectura_ADC(ECG2_pin));
//                WriteStringUART2(buf);
//                break;
//            case 7:
//                if(PORTD != val_ant)
...
//            WriteStringUART2(buf);
//            sprintf(buf,"%d,",lectura_ADC(ECG1_pin)+3000);
//            WriteStringUART2(buf);
//            sprintf(buf,"%d\n",lectura_ADC(ECG2_pin)+6000);
//            WriteStringUART2(buf);
//        }
//        else
//        {
            sprintf(buf,"%d,",lectura_ADC(ECG_pin));
            WriteStringUART2(buf);
            sprintf(buf,"%d,",lectura_ADC(ECG1_pin));
            WriteStringUART2(buf);
            sprintf(buf,"%d\n",lectura_ADC(ECG2_pin));
            WriteStringUART2(buf);
        //}
